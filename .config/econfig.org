...
#+begin_src emacs-lisp :results none
  ...
  "))
#+end_src
Keybindings to increment the number at current point
#+begin_src emacs-lisp :results none
  (defun inc-at-pt (n)
    (interactive "nAmount: ")
    (evil-numbers/inc-at-pt n 0))

  (defun dec-at-pt (n)
    (interactive "nAmount: ")
    (evil-numbers/dec-at-pt n 0))

  (use-package evil-numbers
    :bind ("C-c C-+" . 'inc-at-pt)
    :bind ("C-c C--" . 'dec-at-pt))
#+end_src
** ~utf-8~
#+begin_src emacs-lisp :results none
