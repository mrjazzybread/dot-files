...
#+end_src
Same keybindings as zsh.
#+begin_src emacs-lisp :results none
  (keymap-set esh-autosuggest-active-map "C-f"
    	     #'esh-autosuggest-complete-word)
  (keymap-set esh-autosuggest-active-map "C-e"
    	     #'esh-autosuggest-complete-word)
#+end_src
Increase the history size.  This is helpful when using ~esh-autosuggest~
