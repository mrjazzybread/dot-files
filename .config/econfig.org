...
#+end_src
Add menu item to list albums I haven't listened
#+begin_src emacs-lisp
  (add-to-list 'org-agenda-custom-commands
...
(setq org-todo-keywords
      '((sequence "APPOINTMENT(p)" "SPEC(s)" "TODO(t)" "IN-PROGRESS(i@/!)" "VERIFYING(v!)" "BLOCKED(b@)" "👁️👄👁️(q)" "TOLISTEN(l)" "|" "DONE(d!)" "OBE(o@!)" "WONT-DO(w@/!)" "LISTENED(m@)" )
        ))
;; TODO colors
