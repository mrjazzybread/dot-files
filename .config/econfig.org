...
#+begin_src emacs-lisp
  ...
  (defvar log-file
    (org-directory "art.org.gpg"))
#+end_src
My agenda files:

#+begin_src emacs-lisp
  (setq org-agenda-file-regexp "\\`[^.].*\\.org\\\(\\.gpg\\\)?\\'")
  (setq org-agenda-files (list todo-file agenda-file log-file))
#+end_src
...
#+begin_src emacs-lisp
  (setq org-capture-templates
  	...
  	("l" "Album"
  	 entry (file+headline log-file "Albums")
  	 "* TOLISTEN %?\n %^{Artist}p"
  	 :empty-lines 0)
  	("m" "Movie"
  	 entry (file+headline log-file "Movie")
  	 "* TOWATCH %?\n %^{Recommended}p")))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (setq org-todo-keyword-faces
        '(
          ...
          ("TOLISTEN" . (:foreground "GoldenRod" :weight bold))
  	("TOWATCH" . (:foreground "LightBlue" :weight bold))
          ...
          ("LISTENED" . (:foreground "LimeGreen" :weight bold))
  	("WATCHED" . (:foreground "LimeGreen" :weight bold))
          ))
#+end_src
