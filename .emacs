...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dired-subtree dired-hist ef-themes all-the-icons-ivy-rich ivy-rich-all-the-icons ivy-rich bluetooth smex ivy-posframe counsel yaml-mode htmlize epresent hide-mode-line emacs-hide-mode-line valign
		   #("valign" 0 6
		     (escaped t))
		   #("valign" 0 6
		     (escaped t))
