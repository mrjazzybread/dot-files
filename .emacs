...
(custom-set-variables
 ...
 '(package-selected-packages
   '(all-the-icons-dired all-the-icons-ivy-rich async auctex autothemer
			 bluetooth circe company-coq counsel
			 dired-hist dired-subtree dune eat ef-themes
			 eglot elcord emacsql epresent esh-autosuggest
			 esxml exwm fireplace fish-completion
