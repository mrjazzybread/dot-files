...
\newcommand{\iris}{\textsf{Iris}\xspace}
\newcommand{\heaplang}{\textsf{heaplang}\xspace}
\newcommand{\ocamlgraph}{\textsf{OCamlGraph}\xspace}
\newcommand{\dafny}{\textsf{Dafny}\xspace}
\newcommand{\mixins}{{Mixins}\xspace}
\newcommand{\coq}{\textsf{Rocq}\xspace}
\newcommand{\rocq}{\textsf{Rocq}\xspace}
...
\newcommand{\gospelsl}{\textsf{GospelSL}\xspace}
\newcommand{\cameleer}{\textsf{Cameleer}\xspace}
\newcommand{\whythree}{\textsf{Why3}\xspace}
\newcommand{\gospelcfml}{\textsf{Gospel2CFML}\xspace}
\newcommand{\ortac}{\textsf{Ortac}\xspace}
\newcommand{\stm}{\textsf{QCheck-STM}\xspace}
\newcommand{\stdpp}{\textsf{stdpp}\xspace}
\newcommand{\tlc}{\textsf{TLC}\xspace}
\newcommand{\peter}{\textsf{Peter}\xspace}
\newcommand{\jml}{\textsf{JML}\xspace}
\newcommand{\acsl}{\textsf{ACSL}\xspace}
\newcommand{\framac}{\textsf{Frama-C}\xspace}
\newcommand{\creusot}{\textsf{Creusot}\xspace}
\newcommand{\verifast}{\textsf{Verifast}\xspace}
\newcommand{\viper}{\textsf{Viper}\xspace}
\newcommand{\osiris}{\textsf{Osiris}\xspace}
\newcommand{\refinedc}{\textsf{RefinedC}\xspace}
...
\newcommand{\nubar}{\bar{\nu}}
\newcommand{\alabel}[1]{\quad\text{{\sc #1}}}
\newcommand{\sep}{|\;}
\newcommand{\record}[2]{
...
%% \newcommand{\exttyp}[1]{
%%   \dgste{\mathcal{E}(\Delta)}{\mathcal{E}(\Gamma)}{\mathcal{E}(\Sigma)}
